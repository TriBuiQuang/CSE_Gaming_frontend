                     ...
                     return (
                        <div id="fullpage-wrapper">
                           ...
                           <div className="section">
                              ...
                              <div className="slide">
                                 <p>
                                    [1]: It is your current shop points (SP). Once you transfered CSE to Shop, system will increase point of SP,
                                    current policy 1 x CSE &rarr; 10k points
                                 </p>
                                 ...
                                 <p>
                                    [4]: Game buttons area, you should press <img src={step1_3} alt="step1-3" style={{ display: "initial" }} /> button
                                    to continue to play game after buy Energy thing, system will minus point of Energy thing in SP
                                 </p>
                              </div>
                           </div>
                           <div className="section">
                              ...
                              <p>
                                 - After you pressed "Deposit" button, you will see short guide to do "deposit CSE to the Shop" as below image, and
                                 then scan QR code or click “Copy" button to copy CSE wallet that you need to send to it
                              </p>
