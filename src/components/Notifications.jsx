...
import { UncontrolledAlert, Alert, Button, Card, CardHeader, CardBody, CardTitle, Modal, Row, Col } from "reactstrap";
   ...
   notify = (place) => {
      ...
      options = {
         ...
         message: (
            <div>
               <div>
                  Welcome to <b>Now UI Dashboard React</b> - a beautiful premium admin for every web developer.
               </div>
            </div>
         ),
         type: type,
                     ...
                     <Card>
                        <CardHeader>
                           ...
                           <p className="card-category">
                              ...
                              <a href="https://github.com/mouse0270" rel="noopener noreferrer" target="_blank">
                                 Robert McIntosh
                              </a>
                              . Please checkout the{" "}
                              <a href="http://bootstrap-notify.remabledesigns.com/" rel="noopener noreferrer" target="_blank">
                                 full documentation.
                              </a>
                           </p>
                        </CardHeader>
                           ...
                           <div className="places-buttons">
                              ...
                              <Row>
                                 <Col className="ml-auto mr-auto" lg="8">
                                    <Row>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("tl")} outline>
                                             Top Left
                                          </Button>
                                       </Col>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("tc")} outline>
                                             Top Center
                                          </Button>
                                       </Col>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("tr")} outline>
                                             Top Right
                                          </Button>
                                       </Col>
                                    </Row>
                              ...
                              <Row>
                                 <Col className="ml-auto mr-auto" lg="8">
                                    <Row>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("bl")} outline>
                                             Bottom Left
                                          </Button>
                                       </Col>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("bc")} outline>
                                             Bottom Center
                                          </Button>
                                       </Col>
                                       <Col md="4">
                                          <Button block className="btn-round" color="default" onClick={() => this.notify("br")} outline>
                                             Bottom Right
                                          </Button>
                                       </Col>
                                    </Row>
                              ...
                              <Col className="text-center" md="12">
                                 ...
                                 <Modal isOpen={this.state.modalNotice} toggle={this.toggleModalNotice}>
                                    ...
                                    <div className="modal-body">
                                          ...
                                          <Row>
                                             <Col md="8">
                                                ...
                                                <p className="description">
                                                   The first step is to create an account at <a href="http://www.creative-tim.com/">Creative Tim</a>.
                                                   You can choose a social network or go for the classic version, whatever works best for you.
                                                </p>
                                             </Col>
                                             <Col md="4">
                                                <div className="picture">
                                                   <img alt="..." className="rounded img-raised" src={require("assets/img/bg/daniel-olahs.jpg")} />
                                                </div>
                                             </Col>
                                          </Row>
                                       </div>
                                       <div className="instruction">
                                          <Row>
                                             ...
                                             <Col md="4">
                                                <div className="picture">
                                                   <img alt="..." className="rounded img-raised" src={require("assets/img/bg/david-marcu.jpg")} />
                                                </div>
                                             </Col>
                                          </Row>
                                       </div>
                                    ...
                                    <div className="modal-footer justify-content-center">
                                       <Button className="btn-round" color="info" data-dismiss="modal" type="button" onClick={this.toggleModalNotice}>
                                          Sounds good!
                                       </Button>
                                    </div>
                                 </Modal>
                                 ...
                                 >
                                    ...
                                    <div className="modal-footer">
                                       ...
                                       <div className="divider" />
                                       <div className="right-side">
                                          <Button color="link" data-dismiss="modal" type="button" onClick={this.toggleModalMini}>
                                             Close
                                          </Button>
                                       </div>
                                    </div>
